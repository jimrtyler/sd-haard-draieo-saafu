...
#GUI Variables
$FormTitleText = "ڊسڪ ڪلينر جيم ٽائلر (PowerShellEngineer.com)"
$SelectDiskLabelText = "ڊسڪ چونڊيو:"
$FreeSpaceLabelText = "مفت اسپيس (گيگا بائيٽ):"
$TotalSpaceLabelText = "ڪل اسپيس (گيگا بائيٽ): "
$JunkFoundLabelText = "جنڪ مليو (گيگا بائيٽ):"
$CleanDiskBtnText = "صاف ڊسڪ * فائلون حذف ڪريو*"
$SpaceCleanedLabelText = "صاف ڪيل خلا (گيگا بائيٽ): "
$LogFileLabelText = "لاگ فائل مليو: $abcdefg"
$CreditLabelText = "اسڪرپٽ پاران جم ٽائلر - PowerShellEngineer.com"
$LogFileLocatedText = "لاگ فائل مليو"
$AnalyzingDriveText = "ڊرائيوز جو تجزيو..."
$BrowsersAreRunningText = "برائوزرز هلي رهيا آهن... صارف کي اطلاع ڏيو..."
$PleaseCloseBrowsersText = "مهرباني ڪري سڀ ويب برائوزر بند ڪريو ۽ ٻيهر ڪوشش ڪريو."
$CleaningDriveText = "ڊرائيو جي صفائي..."
